...
var _decimal = require("./decimal9.js");
...
class _Option {
  constructor(jsId, value, options = [], toUpper = false) {
    ...
    options.forEach(option => {
      this[option._jsId] = option._value_set.size == 0 ? option._value : option;
...
const K = Object.freeze({
  ...
  ZERO: Object.freeze(new _decimal.Decimal9(0)),
  ONE: Object.freeze(new _decimal.Decimal9(1)),
  ULP: Object.freeze(_decimal.Decimal9.ulp()),
